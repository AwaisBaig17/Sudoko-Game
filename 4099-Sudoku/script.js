...
//String version of Sudoku
console.log('Stringify version of solved soduku');
var solution = stringifySolvedBoard(solvedBoard);
console.log(solution);

//Making PuzzleBoard from solution board

console.log('Stringify version of puzzled soduku');
...
// It takes the solver sudoku board and difficulty level as an Input and It returns the 
...
// given a number, a row and a sudoku, returns true if the number can be placed in the rows
...
// given a row and a sudoku, returns true if it's a legal column
